...
def main():
    ...
    parser.add_argument("-p1", "--player1", type=str, help="Player 1")
    parser.add_argument("-p2", "--player2", type=str, help="Player 2")
    parser.add_argument("-c1", "--character1", type=str, help="Character 1")
    parser.add_argument("-c2", "--character2", type=str, help="Character 2")
    parser.add_argument("-e", "--event", type=str, help="Event")
    parser.add_argument("-ca1", "--caster1", type=str, help="Caster 1")
    parser.add_argument("-ca2", "--caster2", type=str, help="Caster 2")
    ...
    parser.add_argument("-pw", "--page-workers", type=int, help="Number of page workers")
