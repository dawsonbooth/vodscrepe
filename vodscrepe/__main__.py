...
def main():
    ...
    parser.add_argument("-p", "--progress", type=bool, default=True, help="Display scraping progress")
    parser.add_argument("-v", "--verbose", type=bool, default=False, help="Display error statements")
    parser.add_argument("-j", "--json", type=bool, default=False, help="Output vod with JSON format")
    parser.add_argument("-w", "--workers", type=int, default=10, help="Number of workers")
    parser.add_argument("-pw", "--page-workers", type=int, default=1, help="Number of page workers")
